...
from ibis.backends.base.sql.alchemy.registry import fixed_arity, unary, _cumulative_to_reduction
...
operation_registry.update(
    {
        ...
        ms_ops.StringContains: unary(_string_contains),
        ops.StringFind: _string_contains,
        ops.StringSQLLike: _string_like1,
        # math
